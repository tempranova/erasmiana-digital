...
You can find the current data here: https://d1cmk1mkpb53mi.cloudfront.net/backups/erasmiana-04-12-2025.sql.
...
- Run seed file (`npx prisma db seed`); requires dataset generated by Python processes (inside `processing/` folder)
...
## Original Idea notes (for future development)
