      ...
      <div className="grid grid-cols-2 cardo-regular text-left ">
        ...
        <div className="border-1 border-l-0 border-gray-200">
          ...
          <div className="p-8 pt-6 whitespace-pre-line leading-8">
            {letter.translations[currentTranslation] ? 
              <div>
                {letter.translations[currentTranslation].text ? letter.translations[currentTranslation].text : false}
                {letter.translations[currentTranslation].url ? 
                  <div>
                    <a className="text-green-800 italic flex items-center" href={letter.translations[currentTranslation].url} target="_blank">
                      {letter.translations[currentTranslation].title}
