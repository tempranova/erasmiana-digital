      ...
      <div className="grid cardo-regular text-left w-1/2">
        <div className="border-1 border border-gray-200">
          ...
          <div className="p-8 pt-6 whitespace-pre-line leading-8">
            {work.commentary[currentCommentary] ? 
              <div>
                {work.commentary[currentCommentary].text ? work.commentary[currentCommentary].text : false}
                {work.commentary[currentCommentary].url ? 
                  <div>
                    <a className="text-green-800 italic flex items-center" href={work.commentary[currentCommentary].url} target="_blank">
                      {work.commentary[currentCommentary].title}
            ...
            : false}
            {currentCommentary === work.commentary.length ? 
              work.summary.text
            : false}
          </div>
        </div>
