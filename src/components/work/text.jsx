      ...
      <div className="grid grid-cols-2 cardo-regular text-left ">
        ...
        <div className="border-1 border-l-0 border-gray-200">
          ...
          <div className="p-8 pt-6 whitespace-pre-line leading-8">
            {work.translations[currentTranslation] ? 
              <div>
                {work.translations[currentTranslation].text ? work.translations[currentTranslation].text : false}
                {work.translations[currentTranslation].url ? 
                  <div>
                    <a className="text-green-800 italic flex items-center" href={work.translations[currentTranslation].url} target="_blank">
                      {work.translations[currentTranslation].title}
