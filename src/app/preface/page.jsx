      ...
      <div className="w-[110vh] m-auto">
        <div className="grid grid-cols-2 gap-4 flex-1 text-left">
          <div className="p-4 pt-8">
            <div>
              <Link href="/debate">
                <div className="im-fell-dw-pica-regular-italic text-3xl text-[#3b2d2b] blur-[0.5px] leading-none flex items-center cursor-pointer hover:underline underline-offset-4 decoration-2">
                  Debate
              ...
              <p className="mt-2 ml-4 cardo-regular text-sm text-[#3b2d2b] opacity-80">Chat with an Erasmis AI designed to question your opinions and engage in Erasmian dialogue.</p>
            </div>
            <div className="mt-4">
              <Link href="/learn">
                <div className="im-fell-dw-pica-regular-italic text-3xl text-[#3b2d2b] blur-[0.5px] leading-none flex items-center cursor-pointer hover:underline underline-offset-4 decoration-2">
          ...
          <div className="p-4 mt-4 mb-4 pl-8 max-h-[700px] overflow-y-scroll">
            <div className="text-center">
              <div className="cardo-regular uppercase text-[clamp(1.3rem,_4.3vh,_5rem)] text-[#3b2d2b] leading-none break-all">Erasmiana Digital</div>
            </div>
            <div className="mt-4 cardo-regular text-[clamp(0.7rem,_2vh,_5rem)] text-[#3b2d2b]">Welcome to this humble little website. I've tried to gather the corpus of Erasmus in a way that is fresh, innovative, and true to the sources, in a way that Erasmus might have liked.</div>
            <div className="mt-4 cardo-regular text-[clamp(0.7rem,_2vh,_5rem)] text-[#3b2d2b]"><span className="font-semibold">This website is still in beta.</span> Many of the sources you see will have transcription errors, missing data, and other issues. I'm inviting feedback to see if the concept of this site strikes true or not.</div>
            <div className="mt-4 cardo-regular text-[clamp(0.7rem,_2vh,_5rem)] text-[#3b2d2b]">To learn more about how this site was created, visit the <Link href="/about" className="im-fell-dw-pica-regular-italic text-lg hover:underline underline-offset-4 decoration-2">About</Link> page.</div>
