...
export default async function Page() {
  ...
  return (
    <div id="scroll-container" className="my-4 mx-4 lg:my-auto lg:mx-0 lg:-ml-[20px] w-full max-w-7xl rounded-lg shadow-lg lg:h-[90vh] p-8 bg-no-repeat bg-cover bg-center bg-[url('/assets/bg-parchment-2.png')] lg:overflow-y-auto outline-none">
