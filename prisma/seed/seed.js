...
import workJSON from '../data/seed-annotationes.json' with { type: "json" };
...
async function main() {
  ...
  if(workJSON) {
    ...
    for(let i=0; i < workJSON.works.length; i++) {
            ...
            createMany : {
              data : thisWork.sources.map(source => {
                return {
                  ...
                  title : source.title ? translation.title : "",
      ...
      console.log(`created book id: ${newWork.id}`)
